                        ...
                        {upcoming.length > 0 ? (
                            <ul className="bg-white dark:bg-gray-gray700 rounded-lg shadow divide-y divide-gray-gray100 dark:divide-gray-gray600">
                                {upcoming.map(item => {
                                    ...
                                    const buttonText = hasSubmission ? 'View Submission' : 'Provide Info';
                                    return (
                                        <li key={item.id} className="px-4 py-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 bg-blue-blue text-white rounded-md hover:bg-opacity-90 transition-colors text-sm font-medium flex-shrink-0 min-w-[140px]"
                                                >
                                                    {buttonText}
                                                </button>
                                            </div>
